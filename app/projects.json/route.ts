...
function getTags(slug: string): string[] {
  const tagsMap: Record<string, string[]> = {
    ...
    "warya-security-suite": ["security", "testing", "pentesting", "cybersecurity", "private"],
...
function getTechnologies(slug: string): string[] {
  const techMap: Record<string, string[]> = {
    ...
    "warya-security-suite": ["Python", "Security Tools", "Automation", "AI Integration", "Custom Algorithms"],
